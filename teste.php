...
<table width="" border="0" align="center">
    ...
    <tr>
      <td width="30" align="center" valign="middle" bgcolor="#eee">Código</td>
      <td width="30" align="center" valign="middle" bgcolor="#eee">Cód.Prato</td>
      ...
      <td width="90" align="center" valign="middle" bgcolor="#eee">Status</td>
      <td width="80" align="center" valign="middle" bgcolor="#eee"></td>
    </tr>
    <tr></tr>
    <?php 
    ...
    <tr>
      ...
      <td align="center" valign="middle" bgcolor="#eee"><?php echo str_pad($codPrato, 2, "0", STR_PAD_LEFT); ?></td>
      ...
      <td align="center" valign="middle" bgcolor="#eee"><?php echo $calcStatus;?></td>
      <td align="center" valign="middle" bgcolor="#eee"><input type="submit" name="Pronto" id="Pronto" value="Pronto" /></td> 
